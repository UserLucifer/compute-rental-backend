...
public enum ErrorCode {
    ...
    DOC_SECTION_INVALID(32011, "文档分区无效", HttpStatus.BAD_REQUEST),
    DOC_CATEGORY_SECTION_MISMATCH(32012, "文档分类分区不一致", HttpStatus.BAD_REQUEST),
    DOC_ARTICLE_SECTION_MISMATCH(32013, "文档文章分区与分类分区不一致", HttpStatus.BAD_REQUEST),
    DOC_SECTION_HOME_EXISTS(32014, "该分区已存在已发布首页文档", HttpStatus.CONFLICT),
    DOC_HOME_FLAG_INVALID(32015, "分区首页标记无效", HttpStatus.BAD_REQUEST),
    DOC_LANGUAGE_INVALID(32016, "文档语言无效", HttpStatus.BAD_REQUEST),
    DOC_CATEGORY_LANGUAGE_MISMATCH(32017, "文档分类语言不一致", HttpStatus.BAD_REQUEST),
    DOC_ARTICLE_LANGUAGE_MISMATCH(32018, "文档文章语言与分类语言不一致", HttpStatus.BAD_REQUEST),
