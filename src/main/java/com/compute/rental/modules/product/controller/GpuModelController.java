...
public class GpuModelController {
    ...
    public GpuModelController(ProductCatalogService productCatalogService, LanguageResolver languageResolver) {
    ...
    public ApiResponse<List<GpuModelResponse>> gpuModels(
        ...
        return ApiResponse.success(productCatalogService.listEnabledGpuModels(regionId, locale));
    }
}
