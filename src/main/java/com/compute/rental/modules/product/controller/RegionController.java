...
public class RegionController {
    ...
    public RegionController(ProductCatalogService productCatalogService, LanguageResolver languageResolver) {
    ...
    public ApiResponse<List<RegionResponse>> regions(
        ...
        return ApiResponse.success(productCatalogService.listEnabledRegions(locale));
    }
}
