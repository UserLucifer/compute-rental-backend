...
public class AiModelController {
    ...
    public AiModelController(ProductCatalogService productCatalogService, LanguageResolver languageResolver) {
    ...
    public ApiResponse<List<AiModelResponse>> aiModels(
        ...
        return ApiResponse.success(productCatalogService.listEnabledAiModels(locale));
    }
}
